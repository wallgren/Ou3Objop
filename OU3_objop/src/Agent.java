...
public class Agent {
    ...
    /* Pick a random node from the current node's neighbours. */
    private Node getNextNode(ArrayList<Node> movableNeighbours){
        int nextNodeIndex = (int) Math.random()*movableNeighbours.size();
    }
